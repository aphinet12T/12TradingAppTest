...
const storeAddress = ref(utility.address.storeAddress)
const selectedProvince = ref(utility.address.selectedProvince)
const selectedDistrict = ref(utility.address.selectedDistrict)
const selectedSubdistrict = ref(utility.address.selectedSubdistrict)
const selectedZipcode = ref(utility.address.selectedZipcode)
